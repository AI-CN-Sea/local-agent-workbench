    ...
    <div className="timeline-stack">
      {currentRun && (
        <div className="run-summary">
          <div>
            <strong>{showProviderIds ? `Run ${currentRun.id.slice(0, 8)}` : "Current run"}</strong>
            <small>
          ...
          return (
            <article className="timeline-item" key={step.id}>
              ...
              <div className="timeline-content">
                ...
                {showProviderIds && <small>Provider: {metadataText(metadata.model_provider_id, step.selected_provider_id || "None")}</small>}
